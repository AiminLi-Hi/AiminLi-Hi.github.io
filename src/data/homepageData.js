...
export const PROFILE_DATA = {
  en: {
    ...
    cvDownload: "CV",
    news: [
      { date: "2026-07", label: "GLOBECOM", content: "🎉 Our paper <strong>On the Multi-Weight Shift-Sum Iterative Decoding of Short BCH Codes</strong> was accepted by the <strong>2026 IEEE Global Communications Conference (GLOBECOM 2026)</strong>. Congratulations to my student <strong>Yinglei Yang</strong>!" },
  ...
  zh: {
    ...
    cvDownload: "简历",
    news: [
      { date: "2026-07", label: "GLOBECOM", content: "🎉 我们的论文 <strong>On the Multi-Weight Shift-Sum Iterative Decoding of Short BCH Codes</strong> 被 <strong>2026 IEEE Global Communications Conference（GLOBECOM 2026）</strong>录用。恭喜我的学生 <strong>Yinglei Yang</strong>！" },
